...
const OpenConfigEthView = Backbone.View.extend({
    template: require('templates/open-config-eth.hbs'),

    events: {
        'click .open__config-btn-cancel': 'cancel',
        'click .open__config-btn-ok': 'apply',
        'click .open__config-btn-create': 'create',
...
module.exports = OpenConfigEthView;
